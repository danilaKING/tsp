...
| Коммит    | Описание                                                          |
|-----------|-------------------------------------------------------------------|
| `2507274` | Кнопка начала интервью у отправки фидбека работает как основная   |
| `95bae43` | Редизайн приложения                                               |
| `b8ba27f` | Обновление README                                                 |
| `eb418e7` | Добавлен редактор кода (Monaco Editor)                            |
| `026afa4` | Отказоустойчивость: при перезапуске сервера интервью можно продолжить |
